            ...
            <AnimateWhenVisible direction="fadeInUp">
                <section className="mt-32 p-12 bg-surface-container-low rounded-3xl flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1">
                        ...
                        <div className="space-y-6">
                            <label className="block text-xs font-bold uppercase tracking-widest text-on-surface-variant">Tỷ lệ đóng góp bảo vệ môi trường</label>
                            <div className="relative h-2 w-full bg-surface-container-highest rounded-full overflow-hidden">
                                <div className="absolute top-0 left-0 h-full bg-primary rounded-full transition-all duration-1000 ease-in-out" style={{ width: `${carbonOffsetPercent}%` }}></div>
                            </div>
                            <div className="flex justify-between items-center text-sm font-bold text-primary">
                                <span>{userPurchasedItems || 0} Sản phẩm Đã mua</span>
